...
const char *userid = "000982";            //IoTtweet account user ID (6 digits, included zero pre-fix)
const char *key = "ei7pc3ajk2zu";     //IoTtweet registered device key in "MY IOT Garage"
